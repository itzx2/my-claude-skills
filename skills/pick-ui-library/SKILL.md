...
description: Pick the right library for a given frontend task from a curated, opinionated list — toasts, UI primitives, command menus, charts, virtualization, drag and drop, animated numbers, OTP inputs, state, styling. Use before adding a frontend dependency, and before hand-rolling a toast, dropdown, dialog, command palette, or virtualized list.
---
